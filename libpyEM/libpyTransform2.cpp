...
BOOST_PYTHON_MODULE(libpyTransform2)
{
	...
	class_< EMAN::Symmetry3D, boost::noncopyable, EMAN_Symmetry3D_Wrapper >("Symmetry3D",
		...
		.def("get_nsym",pure_virtual(&EMAN::Symmetry3D::get_nsym), "Gets the total number of unique rotational symmetry operations associated with this symmetry\nFor C symmetry, this is simply nsym\n \nreturn the degree of of cyclic symmetry (nsym)\n")
...
//         .def( other< int >() - self )
    ...
    class_< EMAN::Quaternion >("Quaternion",
    		...
    		"the programmer to rotate an object through a single arbitrary rotation axis.\n\n"
    		"Because the rotation axis is specified as a unit direction vector,\n"
...
//			"  R =  e f g\n"
//			"       j k m\n\n"
//			"provides rotation, scaling and skewing (not yet implemented).\n\n"
...
//	class_< EMAN::Transform, std::auto_ptr<EMAN::Transform>  >("Transform", init<  >())
		...
		.def("rotate_origin", (void (EMAN::Transform::*)(const EMAN::Transform&) )&EMAN::Transform::rotate_origin, args("rotation"), "Increment the rotation using the rotation bit of a transformation matrix.")
		.def("rotate_origin_newbasis", (void (EMAN::Transform::*)(const EMAN::Transform&, const float&, const float&, const float&, const float&) )&EMAN::Transform::rotate_origin_newBasis, args("rotation, omega, n1, n2, n3"), "Increment the rotation using the rotation bit of a transformation matrix.")
		.def("rotate", (void (EMAN::Transform::*)(const EMAN::Transform&) )&EMAN::Transform::rotate, args("rotation"), "Increment the rotation using a transformation matrix.")
		...
		.def("get_mirror",&EMAN::Transform::get_mirror, "Query whether x_mirroring is occurring\n \nreturn whether x_mirroring is occurring\n")
		.def("set_mirror",&EMAN::Transform::set_mirror, args("x_mirror"), "Set whether or not x_mirroring is occurring\n \nx_mirror - whether x_mirroring should be applied\n")
		...
		.def("is_identity", &EMAN::Transform::is_identity, "Returns whether this matrix is the identity\n")
		.def("is_rot_identity", &EMAN::Transform::is_rot_identity, "Returns whether this matrix rotation is the identity\n")
