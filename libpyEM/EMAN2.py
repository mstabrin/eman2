...
def base_name( file_name,extension=False,bdb_keep_dir=False,nodir=False ):
	...
	if file_name[:4].lower()=="bdb:" :
		...
		if nodir or (len(apath)>1 and apath[-2] in ("sets","particles","micrographs","movies","movieparticles","ddd","raw","info","tiltseries","tomograms","rawtomograms","particles3d","movierefs","tilts")) :
			if extension :
